...
public class EditUserData extends AppCompatActivity {
    ...
    private void initValue() {
        ...
        btnSave.setText(getText(R.string.fragment_me_history_btn_edit_user_data));

        inputCitizenID.setEnabled(false);
        inputLaserCode.setEnabled(false);
        inputName.setEnabled(false);
        inputAge.setEnabled(false);
        inputBirthDate.setEnabled(false);
        inputRegistedDate.setEnabled(false);
