 ...
 */
public class FragmentActivityListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            holder.txtProvince.setText(Html.fromHtml(activity.getText(R.string.fragment_activity_txt_province) + provinceList.get(position), Html.FROM_HTML_MODE_LEGACY));
            holder.txtPlace.setText(Html.fromHtml(activity.getText(R.string.fragment_activity_txt_place) + placeList.get(position), Html.FROM_HTML_MODE_LEGACY));
            ...
            holder.txtProvince.setText(Html.fromHtml(activity.getText(R.string.fragment_activity_txt_province) + provinceList.get(position)));
            holder.txtPlace.setText(Html.fromHtml(activity.getText(R.string.fragment_activity_txt_place) + placeList.get(position)));
