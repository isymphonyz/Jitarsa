...
public class FragmentAnnouncementDetail extends Fragment {

    private String TAG = FragmentAnnouncementDetail.this.getClass().getSimpleName();
    ...
    public static FragmentAnnouncementDetail newInstance() {
        FragmentAnnouncementDetail fragment = new FragmentAnnouncementDetail();
        return fragment;
    }

    public static FragmentAnnouncementDetail newInstance(Bundle bundle) {
        FragmentAnnouncementDetail fragment = new FragmentAnnouncementDetail();
