 ...
 */
public class FragmentMePostListAdapter extends BaseAdapter {
    private String TAG = FragmentMePostListAdapter.this.getClass().getSimpleName();
    ...
    public FragmentMePostListAdapter(Activity a) {
