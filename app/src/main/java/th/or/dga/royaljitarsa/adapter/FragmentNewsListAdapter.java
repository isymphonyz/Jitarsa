...
public class FragmentNewsListAdapter extends BaseAdapter {
    private String TAG = FragmentNewsListAdapter.this.getClass().getSimpleName();
    ...
    public FragmentNewsListAdapter(Activity a) {
        activity = a;
    ...
    public void setFragment(FragmentNews fragment) {
