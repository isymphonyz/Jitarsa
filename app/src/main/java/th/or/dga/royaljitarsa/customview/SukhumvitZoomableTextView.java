...
public class SukhumvitZoomableTextView extends AppCompatTextView {
    private static final String TAG = SukhumvitZoomableTextView.class.getSimpleName();
    ...
    public SukhumvitZoomableTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public SukhumvitZoomableTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public SukhumvitZoomableTextView(Context context) {
        super(context);
        tf = Typeface.createFromAsset(context.getAssets(), "fonts/sukhumvitset.ttf");
        this.setTypeface(tf);
        this.setTextSize(TypedValue.COMPLEX_UNIT_SP, context.getResources().getDimension(R.dimen.text_size));
