 ...
 */
public class FragmentSaveListAdapter extends BaseAdapter {
    ...
    public FragmentSaveListAdapter(Activity a) {
        activity = a;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        vi = inflater.inflate(R.layout.fragment_save_list_item, null);
