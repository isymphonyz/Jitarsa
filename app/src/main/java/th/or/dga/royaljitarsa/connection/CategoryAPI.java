...
public class CategoryAPI extends AsyncTask<String, Void, String> {
    ...
    public interface CategoryAPIListener {
        void onCategoryAPIPreExecuteConcluded();
        void onCategoryAPIPostExecuteConcluded(String result);
    }

    private String TAG = CategoryAPI.this.getClass().getSimpleName();
    ...
    private CategoryAPIListener mListener;

    final public void setListener(CategoryAPIListener listener) {
        mListener = listener;
    }
    ...
    protected void onPreExecute() {
        ...
        if (mListener != null) {
            mListener.onCategoryAPIPreExecuteConcluded();
        }
    }
    ...
    protected void onPostExecute(String result) {
        ...
        if (mListener != null) {
            mListener.onCategoryAPIPostExecuteConcluded(result);
        }
    }
