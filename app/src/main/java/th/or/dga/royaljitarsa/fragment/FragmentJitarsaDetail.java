...
public class FragmentJitarsaDetail extends Fragment {

    private String TAG = FragmentJitarsaDetail.this.getClass().getSimpleName();
    ...
    public static FragmentJitarsaDetail newInstance(Bundle bundle) {
        FragmentJitarsaDetail fragment = new FragmentJitarsaDetail();
