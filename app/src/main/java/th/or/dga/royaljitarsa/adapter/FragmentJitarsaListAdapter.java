 ...
 */
public class FragmentJitarsaListAdapter extends BaseAdapter {
    private String TAG = FragmentJitarsaListAdapter.this.getClass().getSimpleName();
    ...
    private FragmentJitarsa fragment;
    ...
    public FragmentJitarsaListAdapter(Activity a) {
        activity = a;
    ...
    public void setFragment(FragmentJitarsa fragment) {
