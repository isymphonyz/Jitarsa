...
public class GetProfileAPI extends AsyncTask<String, Void, String> {

    public interface GetProfileAPIListener {
        void onGetProfileAPIPreExecuteConcluded();
        void onGetProfileAPIPostExecuteConcluded(String result);
    }

    private String TAG = GetProfileAPI.this.getClass().getSimpleName();

    public static final MediaType JSON = MediaType.parse("application/json; charset=utf-8");

    private OkHttpClient okHttpClient;
    private String url = MyConfiguration.DOMAIN + MyConfiguration.URL_GET_PROFILE;
    ...
    protected void onPreExecute() {
        ...
        if (mListener != null) {
            mListener.onGetProfileAPIPreExecuteConcluded();
        }
    }
    ...
    protected void onPostExecute(String result) {
        ...
        if (mListener != null) {
            mListener.onGetProfileAPIPostExecuteConcluded(result);
        }
    }
