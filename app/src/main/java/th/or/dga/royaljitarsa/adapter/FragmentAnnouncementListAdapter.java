 ...
 */
public class FragmentAnnouncementListAdapter extends BaseAdapter {
    private String TAG = FragmentAnnouncementListAdapter.this.getClass().getSimpleName();
    ...
    private FragmentAnnouncement fragment;
    ...
    public FragmentAnnouncementListAdapter(Activity a) {
        activity = a;
    ...
    public void setFragment(FragmentAnnouncement fragment) {
